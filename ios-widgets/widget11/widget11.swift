...
struct WidgetProvider: TimelineProvider {
    func placeholder(in context: Context) -> SimpleEntry {
        SimpleEntry(date: Date(), quoteText: "I wish I had a friend like me", backgroundColor: Color(hex: "F26B83"))
    }

    func getSnapshot(in context: Context, completion: @escaping (SimpleEntry) -> ()) {
        let entry = SimpleEntry(date: Date(), quoteText: "I wish I had a friend like me", backgroundColor: Color(hex: "F26B83"))
        completion(entry)
    }
...
struct WidgetBundle: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Kids See Ghosts")
        .description("No not Miami, Switzerland")
...
struct Widget_Previews: PreviewProvider {
    static var previews: some View {
        WidgetEntryView(entry: SimpleEntry(date: Date(), quoteText: "I wish I had a friend like me", backgroundColor: Color(hex: "F26B83")))
