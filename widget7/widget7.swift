...
struct WidgetProvider: TimelineProvider {
    func placeholder(in context: Context) -> SimpleEntry {
        SimpleEntry(date: Date(), quoteText: "We will change the paradigm", backgroundColor: Color(hex: "000000"))
    }

    func getSnapshot(in context: Context, completion: @escaping (SimpleEntry) -> ()) {
        let entry = SimpleEntry(date: Date(), quoteText: "We will change the paradigm", backgroundColor: Color(hex: "000000"))
        completion(entry)
    }
                ...
                URLSession.shared.dataTask(with: url) { data, response, error in
                    if let data = data, let quoteText = String(data: data, encoding: .utf8) {
                        ...
                        if quoteText.count < 50 {
                            ...
                            let entry = SimpleEntry(date: Date(), quoteText: quoteText, backgroundColor: Color(hex: "000000"))
        ...
        ZStack {
            ...
            VStack {
                Text(entry.quoteText)
                    ...
                    .padding()
                    .foregroundColor(Color(hex: "#807f76"))
            }
        }
    }
}
...
struct WidgetBundle: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Donda")
        .description("I think I see Messi")
...
struct Widget_Previews: PreviewProvider {
    static var previews: some View {
        WidgetEntryView(entry: SimpleEntry(date: Date(), quoteText: "We will change the paradigm", backgroundColor: Color(hex: "000000")))
