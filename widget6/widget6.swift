...
struct WidgetProvider: TimelineProvider {
    func placeholder(in context: Context) -> SimpleEntry {
        SimpleEntry(date: Date(), quoteText: "Wrestlin' with God, I don't really want to wrestle", backgroundColor: Color(hex: "0D15A6"))
    }

    func getSnapshot(in context: Context, completion: @escaping (SimpleEntry) -> ()) {
        let entry = SimpleEntry(date: Date(), quoteText: "Wrestlin' with God, I don't really want to wrestle", backgroundColor: Color(hex: "0D15A6"))
        completion(entry)
    }
                ...
                URLSession.shared.dataTask(with: url) { data, response, error in
                    if let data = data, let quoteText = String(data: data, encoding: .utf8) {
                        ...
                        if quoteText.count < 50 {
                            ...
                            let entry = SimpleEntry(date: Date(), quoteText: quoteText, backgroundColor: Color(hex: "0D15A6"))
        ...
        ZStack {
            ...
            VStack {
                Text(entry.quoteText)
                    ...
                    .padding()
                    .foregroundColor(Color(hex: "#FFE000"))
            }
        }
    }
}
...
struct WidgetBundle: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Jesus is King")
        .description("Sometimes you have to get rid of everything")
...
struct Widget_Previews: PreviewProvider {
    static var previews: some View {
        WidgetEntryView(entry: SimpleEntry(date: Date(), quoteText: "Wrestlin' with God, I don't really want to wrestle", backgroundColor: Color(hex: "0D15A6")))
